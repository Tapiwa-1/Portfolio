...
<div class="container">
    <div class="col-md-12">
        ...
        <div class="form-group">
            ...
            <input type="text" name="projectname" id="" class="form-control" required>
        </div>
        <div class="form-group">
            <label for="">Project finish date</label>
            <input type="text" name="finishdate" id="" class="form-control" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea name="moredetails" id="" cols="30" rows="10" class="form-control" required></textarea>
        </div>
        <div class="form-group">
            <label for="">GitHub Link</label>
            <input type="text" name="githublink" id="" class="form-control" required>
        </div>
